...
Running `mvn deploy` from IntelliJ will not prompt for gpg passphrase.
Instead this fails with this error: `gpg: signing failed: No such file or directory`
Copy the maven command generated by IntelliJ and paste into a terminal window, and this will prompt for passphrase correctly.
